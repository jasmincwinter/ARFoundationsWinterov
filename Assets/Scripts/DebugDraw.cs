...
public static class DebugDraw
{
    ...
    public static void DrawPointer(Vector3 a, Vector3 b, float arrowSize, Color color, float duration = 0, bool depthTest = false)
    {
        DrawArrow(a, b - a, arrowSize, color, duration, depthTest);
    }

    public static void DrawArrow(Vector3 position, Vector3 direction, float arrowSize, Color color, float duration = 0, bool depthTest = false)
    {
